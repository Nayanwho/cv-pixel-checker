...
export const CV_PRESETS = [
  {
    ...
    name: '💼 Internship & Work Experience (Calibrated Skynet 578px)',
    shortLabel: 'Internship & Work Exp',
    description: 'Calibrated Skynet Limit: Category Col + Net Printable Text (433.5pt / 578.0px safe limit)',
  ...
  },
  {
    ...
    name: '🏆 Competitions & Extra-Curriculars (Calibrated Skynet 521px)',
    shortLabel: 'Competitions & Extra-Curriculars',
    description: 'Calibrated Skynet Limit: Category + Year Col + Net Printable Text (390.75pt / 521.0px safe limit)',
  ...
  {
    id: 'preset_academics',
    name: '🎓 Academic Achievements & Certifications (Calibrated Skynet 635px)',
    shortLabel: 'Academic Achievements',
    description: 'Calibrated Skynet Limit: Wide Section + Year Col (476.25pt / 635.0px safe limit)',
  ...
  {
    id: 'preset_por',
    name: '🎯 Position of Responsibility - POR (Calibrated Skynet 521px)',
    shortLabel: 'Positions of Responsibility',
    description: 'Calibrated Skynet Limit: Role Col + Year Col + Net Printable Text (390.75pt / 521.0px safe limit)',
