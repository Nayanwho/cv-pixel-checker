...
// OpenAI plugin directory domain verification. Configure the exact token
// generated by the submission portal as OPENAI_APPS_CHALLENGE in production.
app.get('/.well-known/openai-apps-challenge', (req, res) => {
  const challenge = process.env.OPENAI_APPS_CHALLENGE;
  if (!challenge) {
    return res.status(404).type('text/plain').send('Challenge token not configured');
  }
